 ...
 * Generated at: 2024-09-09 00:40:25 UTC
...
public final class rootpage_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    if (excludeHeader == null || !excludeHeader) {
      ...
      out.write('\n');
      out.write("\r\n");
      out.write("<link rel=\"stylesheet\" href=\"/mini/css/rootpage.css\" type=\"text/css\"/>\r\n");
      out.write("<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\">\r\n");
      out.write("<script>\r\n");
      out.write("window.onload = function () {\r\n");
      out.write("    reloadPage(1);  // 첫 번째 페이지를 로드합니다.\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("function reloadPage(page) {\r\n");
      out.write("    $.ajax({\r\n");
      out.write("        url: \"/mini/adminpage/mem\",\r\n");
      out.write("        type: \"GET\",\r\n");
      out.write("        data: {\r\n");
      out.write("            page: page  // 현재 페이지 번호를 서버에 전달\r\n");
      out.write("        },\r\n");
      out.write("        success: function (response) {\r\n");
      out.write("            var members = response.members;  // 회원 목록\r\n");
      out.write("            var pVO = response.pVO;  // 페이징 정보\r\n");
      out.write("\r\n");
      out.write("            // 1. 회원 목록 렌더링\r\n");
      out.write("            var tag = \"<li><p id='checkbutton'><button class='btn btn-outline-secondary' style='flex-shrink: 0;'type='button' onclick='checkboxon()'>일괄선택</button><button class='btn btn-outline-secondary' id='oncheck' type='button' style='display: none;' onclick='checkedboxon()'>일괄체크</button></p>\";\r\n");
      out.write("            tag += \"<div id='usertitle2'><div class='memid '>아이디 </div><div class='memname'>이름</div><div class='mememail'>이메일</div>\";\r\n");
      out.write("            tag += \"<div class='memtel'>전화번호</div><div class='memaddr'>주소</div><div class='memaddrdetail'>상세주소</div>\";\r\n");
      out.write("            tag += \"<div class='memwritedate'>가입일</div></div></li>\";\r\n");
      out.write("            \r\n");
      out.write("            members.forEach(function (member) {\r\n");
      out.write("                tag += \"<li><div><input type='checkbox' name='test[]' class='checkbox' style='display: none;' value='\" + member.userid + \"'/>\";\r\n");
      out.write("                tag += \"<div class='memid'>\" + member.userid + \"</div><div class='memname'>\" + member.username + \"</div>\";\r\n");
      out.write("                tag += \"<div class='mememail'>\" + member.email + \"</div><div class='memtel'>\" + member.tel + \"</div><div class='memaddr'>\" + member.addr + \"</div>\";\r\n");
      out.write("                tag += \"<div class='memaddrdetail'>\" + member.addrdetail + \"</div>\" +\r\n");
      out.write("                \"<div class='memwritedate'>\" + member.writedate + \"</div>\" +\r\n");
      out.write("                \"<button class='btn btn-outline-secondary' type='button' style='flex-shrink: 0;' onclick='userdel(\\\"\" + member.userid + \"\\\")'>탈퇴</button></div></li>\";\r\n");
      out.write("            });\r\n");
      out.write("\r\n");
      out.write("            $(\"#userList\").html(tag);\r\n");
      out.write("\r\n");
      out.write("            // 2. 페이징 정보 렌더링\r\n");
      ...
      out.write("            document.getElementById('memDel').style.display = \"block\";\r\n");
      ...
      out.write("            document.getElementById('memDel').style.display = \"none\";\r\n");
      ...
      out.write("        checkbox.forEach(function (checkbox) {\r\n");
      out.write("            checkbox.checked = false;  // 체크 해제\r\n");
      out.write("        });\r\n");
      out.write("    } else {\r\n");
      out.write("        checkbox.forEach(function (checkbox) {\r\n");
      out.write("            checkbox.checked = true;  // 체크 선택\r\n");
      out.write("        });\r\n");
      out.write("    }\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("function userdel(userid) {\r\n");
      out.write("    if (confirm(\"정말 삭제하시겠습니까?\")) {\r\n");
      out.write("    	$.ajax({\r\n");
      out.write("    		url:\"/mini/adminpage/userDel/\",\r\n");
      out.write("    		type:\"post\",\r\n");
      ...
      out.write("			\r\n");
      out.write("			<div>\r\n");
      out.write("				<form method=\"post\" action=\"/mini/adminpage/memDel\">	\r\n");
      out.write("					<ul id=\"userList\">\r\n");
      out.write("					</ul>\r\n");
      out.write("					<input class=\"btn btn-outline-secondary\" id='memDel'  type=\"submit\" value=\"삭제\" style=\"display: none;\"/>\r\n");
      out.write("				</form>	\r\n");
      out.write("			</div>\r\n");
      out.write("				\r\n");
      out.write("		</div>\r\n");
      ...
      out.write("				<ul>\r\n");
      out.write("					<li class=\"on\"><a href=\"/mini/mypage/rootpage\">회원관리</a></li>\r\n");
      out.write("					<li ><a href=\"/mini/adminpage/boardList\">게시글관리</a></li>\r\n");
