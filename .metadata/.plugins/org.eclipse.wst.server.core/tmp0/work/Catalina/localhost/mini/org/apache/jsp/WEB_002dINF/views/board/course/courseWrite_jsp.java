 ...
 * Generated at: 2024-09-09 03:31:05 UTC
...
public final class courseWrite_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    if (excludeHeader == null || !excludeHeader) {
      ...
      out.write("       CKEDITOR.ClassicEditor\r\n");
      out.write("           .create(document.getElementById('content'), option)\r\n");
      out.write("           .then(editor => {\r\n");
      out.write("               console.log('CKEditor 5 is ready.');\r\n");
      out.write("               window.editorInstance = editor; // 에디터 인스턴스를 전역 변수로 저장\r\n");
      out.write("           })\r\n");
      out.write("           .catch(error => {\r\n");
      out.write("               console.error('CKEditor 5 initialization error:', error);\r\n");
      out.write("           });\r\n");
      out.write("   };\r\n");
      out.write("   //글등록\r\n");
      out.write("   function courseFormCheck() {\r\n");
      out.write("      const subject = document.getElementById(\"subject\").value.trim();\r\n");
      out.write("      const content = window.editorInstance.getData(); // Get the HTML content from CKEditor\r\n");
      out.write("\r\n");
      ...
      out.write("      }\r\n");
      out.write("      \r\n");
      out.write("      // Check if there's at least one image in the content\r\n");
      out.write("      const parser = new DOMParser();\r\n");
      out.write("      const doc = parser.parseFromString(content, 'text/html');\r\n");
      out.write("      const images = doc.querySelectorAll('img');\r\n");
      out.write("      \r\n");
      out.write("      if (images.length === 0) {\r\n");
      out.write("         alert(\"썸네일에 사용될 이미지를 최소 1장 업로드 해주세요.\");\r\n");
      out.write("         return false;\r\n");
      out.write("      }\r\n");
      out.write("\r\n");
      ...
      out.write("      <h2 style=\"text-align: center; padding: 20px 0px;\">나만의 코스짜기</h2>\r\n");
      out.write("      \r\n");
      out.write("      <form method=\"post\" action=\"/mini/course/courseWriteResult\" onsubmit=\"return courseFormCheck()\">\r\n");
      out.write("         <select class=\"form-select\" name=\"schedule\" style=\"width: 150px;\">\r\n");
      out.write("               <option value=\"1\">당일치기</option>\r\n");
      out.write("               <option value=\"2\">1박2일</option>\r\n");
      out.write("               <option value=\"3\">2박3일</option>\r\n");
      out.write("               <option value=\"4\">3박4일</option>\r\n");
      out.write("            </select>\r\n");
      out.write("         <input type=\"text\" name=\"subject\" id=\"subject\" class=\"form-control mt-3\" placeholder=\"제목을 입력하세요.\">\r\n");
      out.write("         <textarea name=\"content\" id=\"content\"></textarea>\r\n");
      out.write("         <button class=\"btn btn-outline-success\">등록하기</button>\r\n");
      out.write("      </form>\r\n");
      out.write("   </div>\r\n");
      out.write("</body>\r\n");
      out.write("</html>\r\n");
