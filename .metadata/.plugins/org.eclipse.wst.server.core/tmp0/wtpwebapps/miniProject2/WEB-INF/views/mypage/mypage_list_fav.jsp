...
<div class="mypageFavFrm">
    ...
    <c:forEach var="festival" items="${likedFestivals}">
        <li class="bdr_nor">
            <div class="photo">
                <a href="/mini/festival/festivalView/${festival.no}">
                    <img src="/mini/images/poster/${festival.poster}" style="width: 220px; height: 180px;">
                </a>
            </div>
            <div class="area_txt">
                <div class="tit">
                    <a href="/mini/festival/festivalView/${festival.no}" style="color: black; text-decoration: none; font-size:1.1em; font-weight: bold;">${festival.title}</a>
                </div>
            </div>
        ...
        <li class="bdr_nor">
            <div class="photo">
                <a href="/mini/rest/restView/${restaurant.rest_code}">
                    <img src="/mini/images/Food/${restaurant.imageurl}" style="width: 220px; height: 180px;">
                </a>
            </div>
            <div class="area_txt">
                <div class="tit">
                    <a href="/mini/rest/restView/${restaurant.rest_code}" style="color: black; text-decoration: none; font-size:1.1em; font-weight: bold;">${restaurant.store_name}</a>
                </div>
            </div>
			...
			<div class="box_rightType1">
				...
				<div class="snb_mypage">
					<ul>
						<li class="on"><a href="/mini/mypage/mypage_list_fav">찜목록</a></li>
