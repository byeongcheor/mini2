...
<div class="joinFrm">
 <h1 class="loginTop"><img src="/mini/images/main/logo.png"></h1>
	<form method="post" action="/mini/mypage/joinOk" onsubmit="return formCheck()">
		<div class="joinMain">
			<div class="joinN">아이디</div>
			<div class="joinI">
				<input type="text" name="userid" id="userid" minlength="8" maxlength="15" onkeyup="setKeyCheck()" />
			...
			<div class="joinI">
				<input type="text" name="addr" id="addr" style="width:70%"/>
			</div>
